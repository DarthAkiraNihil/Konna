...
public class KHashMapIntWeightedGraph<IDX, COL> implements KIntWeightedGraph<IDX, COL> {

    private final class HashMapGraphNode implements KIntWeightedGraph.Node<IDX, COL> {
