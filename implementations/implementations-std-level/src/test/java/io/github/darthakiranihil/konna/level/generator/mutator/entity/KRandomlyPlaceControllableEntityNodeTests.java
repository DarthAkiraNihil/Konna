...
public class KRandomlyPlaceControllableEntityNodeTests extends KStandardTestClass {
    ...
    public void testProcessSuccess() {
        ...
        params.put("name", "rnd_ce");
        params.put("descriptor", "rnd_ce");

        var node = new KRandomlyPlaceControllableEntityNode(es);
        ...
        var created = tool.findEntitiesWithDescriptor("rnd_ce");
        Assertions.assertEquals(1, created.size());
        Assertions.assertEquals("rnd_ce", created.getFirst().name());
        Assertions.assertInstanceOf(KControllableEntity.class, created.getFirst());
