...
public class KStraightPathsBetweenBinaryPartitionCentersNodeTests extends KStandardTestClass {
    ...
    public void testProcessSuccess() {
        ...
        var node = new KStraightPathsBetweenBinaryPartitionCentersNode();
        ...
        Assertions.assertEquals(KPassabilityState.PASSABLE, layer.getOnPosition(90, 30));
        //Assertions.assertEquals(KPassabilityState.PASSABLE, layer.getOnPosition(30, 30));

    }

    @Test
    public void testProcessFailedBecauseThereAreMoreThan2Subpartitions() {
        ...
        Assertions.assertThrows(
            ...
            () -> {
                ...
                var node = new KStraightPathsBetweenBinaryPartitionCentersNode();
                node.process(params, new Random(1234569L));
            }
        );
