...
public class KRemoveWeakDisjointWallsNodeTests extends KStandardTestClass {
    ...
    public void testProcessSuccess() {
        ...
        tool.setState(1, 1, KPassabilityState.IMPASSABLE);
        tool.setState(1, 2, KPassabilityState.IMPASSABLE);

        tool.setState(0, 0, KPassabilityState.PASSABLE);
        tool.setState(0, 1, KPassabilityState.PASSABLE);
        tool.setState(0, 2, KPassabilityState.PASSABLE);

        tool.setState(2, 0, KPassabilityState.PASSABLE);
        tool.setState(2, 1, KPassabilityState.PASSABLE);
        tool.setState(2, 2, KPassabilityState.PASSABLE);
        ...
        KRemoveWeakDisjointWallsNode node = new KRemoveWeakDisjointWallsNode();
        ...
        Assertions.assertEquals(KPassabilityState.PASSABLE, layer.getOnPosition(1, 0));
        Assertions.assertEquals(KPassabilityState.PASSABLE, layer.getOnPosition(1, 1));
        Assertions.assertEquals(KPassabilityState.PASSABLE, layer.getOnPosition(1, 2));
