...
public sealed class KGl20Lwjgl extends KObject implements KGl20 permits KGl33Lwjgl {
    ...
    @Override
    public @Nullable String glGetString(int name) {
    ...
    public void glTexImage1D(
        ...
        int format,
        int type,
        final @Nullable ShortBuffer pixels
    ) {
        GL20.glTexImage1D(target, level, internalformat, width, border, format, type, pixels);
    }
    ...
    public void glTexImage1D(
        ...
        int format,
        int type,
        final @Nullable IntBuffer pixels
    ) {
        GL20.glTexImage1D(target, level, internalformat, width, border, format, type, pixels);
    }
    ...
    public void glTexImage1D(
        ...
        int format,
        int type,
        final @Nullable FloatBuffer pixels
    ) {
        GL20.glTexImage1D(target, level, internalformat, width, border, format, type, pixels);
    }
    ...
    public void glTexImage1D(
        ...
        int format,
        int type,
        final @Nullable DoubleBuffer pixels
    ) {
        GL20.glTexImage1D(target, level, internalformat, width, border, format, type, pixels);
    }
    ...
    @Override
    public final @Nullable ByteBuffer glMapBuffer(int target, int access) {
