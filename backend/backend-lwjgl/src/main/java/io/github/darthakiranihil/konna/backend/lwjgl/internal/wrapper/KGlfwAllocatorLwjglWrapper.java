...
import io.github.darthakiranihil.konna.libfrontend.glfw.KGlfwAllocator;
import org.lwjgl.glfw.GLFWAllocator;
import org.lwjgl.glfw.GLFWDeallocateCallback;

public final class KGlfwAllocatorLwjglWrapper extends KWrapper<KGlfwAllocator, GLFWAllocator> {

    public KGlfwAllocatorLwjglWrapper(
        KGlfwAllocator original
    ) {
        super(original);
    }

    @Override
    protected GLFWAllocator wrap(KGlfwAllocator original) {
