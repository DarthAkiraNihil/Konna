...
public final class KPackageIndex extends KUninstantiable {

    private static final List<Package> PACKAGE_INDEX = new ArrayList<>();
    ...
    static {
        ...
        try (
            ...
            var classIndex = KClassIndex.getClassIndex();
            KPackageIndex.PACKAGE_INDEX.addAll(
                classIndex
                    .stream()
    ...
    public static List<Package> getPackageIndex() {
        return Collections.unmodifiableList(KPackageIndex.PACKAGE_INDEX);
    }
