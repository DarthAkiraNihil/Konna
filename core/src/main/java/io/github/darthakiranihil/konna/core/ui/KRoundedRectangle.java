...
public record KRoundedRectangle(
    ...
    public KRoundedRectangle(final KVector2d coordinates, final KSize size, final KSize arcSize) {
        this(coordinates, size, arcSize, null, null);
    }

    public KRoundedRectangle(final KVector2d coordinates, final KSize size, final KSize arcSize, final KColor outlineColor) {
        this(coordinates, size, arcSize, outlineColor, null);
    }

    public KRoundedRectangle(final KVector2d coordinates, final KSize size, final KSize arcSize, final KColor outlineColor, final KColor fillColor) {
    ...
    public static KRoundedRectangle square(final KVector2d coordinates, int side, final KSize arcSize) {
        return new KRoundedRectangle(coordinates, KSize.squared(side), arcSize);
    }

    public static KRoundedRectangle square(final KVector2d coordinates, int side, final KSize arcSize, final KColor outlineColor) {
        return new KRoundedRectangle(coordinates, KSize.squared(side), arcSize, outlineColor);
    }

    public static KRoundedRectangle square(final KVector2d coordinates, int side, final KSize arcSize, final KColor outlineColor, final KColor fillColor) {
