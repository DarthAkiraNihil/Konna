...
public interface KGlfw {
    ...
    void glfwGetMonitorPos(long monitor, int[] xpos, int[] ypos);
    void glfwGetMonitorWorkarea(long monitor, int[] xpos, int[] ypos, int[] width, int[] height);
    void glfwGetMonitorPhysicalSize(long monitor, int[] widthMM, int[] heightMM);
    void glfwGetMonitorContentScale(long monitor, float[] xscale, float[] yscale);
    void glfwGetWindowPos(long window, int[] xpos, int[] ypos);
    void glfwGetWindowSize(long window, int[] width, int[] height);
    void glfwGetFramebufferSize(long window, int[] width, int[] height);
    void glfwGetWindowFrameSize(long window, int[] left, int[] top, int[] right, int[] bottom);
    void glfwGetWindowContentScale(long window, float[] xscale, float[] yscale);
    void glfwGetCursorPos(long window, double[] xpos, double[] ypos);
    void glfwGetPreeditCursorRectangle(long window, int[] x, int[] y, int[] w, int[] h);
