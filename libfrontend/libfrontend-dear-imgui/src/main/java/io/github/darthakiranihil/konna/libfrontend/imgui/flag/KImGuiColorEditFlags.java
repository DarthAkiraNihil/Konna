...
public final class KImGuiColorEditFlags {
    ...
    /**
     * ColorEdit, ColorPicker, ColorButton: ignore Alpha component (will only read 3 components from
     * the input pointer).
     *
    ...
    /**
     * ColorEdit, ColorPicker: disable color square preview next to the inputs. (e.g. to show only
     * the inputs)
     *
    ...
    /**
     * ColorEdit, ColorPicker: disable inputs sliders/text widgets (e.g. to show only the small
    ...
    /**
     * ColorEdit, ColorPicker: disable display of inline text label (the label is still forwarded to
    ...
    /**
     * ColorEdit, ColorPicker, ColorButton: display half opaque / half checkerboard, instead of
     * opaque.
     *
    ...
    /**
     * [Display]    // ColorEdit: override _display_ type among RGB/HSV/Hex. ColorPicker: select any
    ...
    /**
     * [DataType]   // ColorEdit, ColorPicker, ColorButton: _display_ values formatted as 0.0f..1.0f
     ...
     *
     * <p>Definition:
     * {@code ImGuiColorEditFlags_Uint8 | ImGuiColorEditFlags_DisplayRGB |
     ...
     *
     * <p>Definition:
     * {@code ImGuiColorEditFlags_DisplayRGB | ImGuiColorEditFlags_DisplayHSV |
