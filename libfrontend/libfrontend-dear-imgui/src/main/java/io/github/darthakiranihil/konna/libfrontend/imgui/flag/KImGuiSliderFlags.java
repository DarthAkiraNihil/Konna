...
/**
 * Flags for ImGui::Slider().
 *
 * @author Darth Akira Nihil
 * @since 0.1.0
 */
public final class KImGuiSliderFlags {
    /**
     * Definition: {@code 0}
     */
     ...
     * ImGuiSliderFlags_NoRoundToFormat with this if using a format-string with small amount of
     * digits.
     *
    ...
    /**
     * Disable rounding underlying value to match precision of the display format string (e.g. %.3f
    ...
    /**
     * [Internal] We treat using those bits as being potentially a 'float power' argument from the
