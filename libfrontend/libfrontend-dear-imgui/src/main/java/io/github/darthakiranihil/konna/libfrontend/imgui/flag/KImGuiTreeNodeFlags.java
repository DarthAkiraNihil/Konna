 ...
 * @since 0.1.0
 */
public final class KImGuiTreeNodeFlags {
    /**
     * Definition: {@code 0}
     */
    ...
    /**
     * Don't do a TreePush() when open (e.g. for CollapsingHeader) = no extra indent nor pushing on
     * ID stack
     *
    ...
    /**
     * Only open when clicking on the arrow part. If ImGuiTreeNodeFlags_OpenOnDoubleClick is also
    ...
    /**
     * Display a bullet instead of arrow. IMPORTANT: node can still be marked open/close if you
     * don't set the _Leaf flag!
     *
    ...
    /**
     * (WIP) Nav: left direction may move to this TreeNode() from any of its child (items submitted
    ...
    /**
     * ImGuiTreeNodeFlags_NoScrollOnOpen     = 1 {@code <<} 16,
     * scroll on TreePop() if node got just open and contents is not visible
     *
     * <p>Definition:
     * {@code ImGuiTreeNodeFlags_Framed | ImGuiTreeNodeFlags_NoTreePushOnOpen |
