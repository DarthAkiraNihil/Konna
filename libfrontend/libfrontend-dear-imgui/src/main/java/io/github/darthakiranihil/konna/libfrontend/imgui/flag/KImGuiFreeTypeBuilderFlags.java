...
/**
 * Flags for ImGuiFreeTypeBuilder.
 *
 * @author Darth Akira Nihil
 * @since 0.1.0
 */
public final class KImGuiFreeTypeBuilderFlags {
    /**
     * Disable hinting. This generally generates 'blurrier' bitmap glyphs when the glyph are
     * rendered in any of the anti-aliased modes.
     *
     ...
     * only vertically (Y-axis), as is done by Microsoft's ClearType and Adobe's proprietary font
    ...
    private KImGuiFreeTypeBuilderFlags() {
    }
}
