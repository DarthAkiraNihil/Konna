 ...
 * @since 0.3.0
 */
public final class KImGuiTabBarFlags {
    /**
     * Definition: {@code 0}
     */
    ...
    /**
     * Disable behavior of closing tabs (that are submitted with p_open != NULL) with middle mouse
     * button. You may handle this behavior manually on user's side with if (IsItemHovered()
     * {@code &} {@code &} IsMouseClicked(2)) *p_open = false.
     *
    ...
    /**
     * Definition:
     * {@code ImGuiTabBarFlags_FittingPolicyResizeDown | ImGuiTabBarFlags_FittingPolicyScroll}
     */
