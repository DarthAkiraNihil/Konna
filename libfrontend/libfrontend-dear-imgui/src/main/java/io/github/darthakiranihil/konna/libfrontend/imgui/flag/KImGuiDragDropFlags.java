...
public final class KImGuiDragDropFlags {
    ...
    /**
     * Disable preview tooltip. By default, a successful call to BeginDragDropSource opens a tooltip
    ...
    /**
     * Disable the behavior that allows to open tree nodes and collapsing header by holding over
    ...
    /**
     * Automatically expire the payload if the source cease to be submitted (otherwise payloads are
    ...
    /**
     * AcceptDragDropPayload() will returns true even before the mouse button is released. You can
     ...
     *
     * <p>Definition:
     * {@code ImGuiDragDropFlags_AcceptBeforeDelivery | ImGuiDragDropFlags_AcceptNoDrawDefaultRect}
     */
