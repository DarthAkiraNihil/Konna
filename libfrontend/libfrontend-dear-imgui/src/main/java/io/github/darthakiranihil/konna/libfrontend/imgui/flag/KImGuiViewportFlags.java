 ...
 * @since 0.1.0
 */
public final class KImGuiViewportFlags {
    /**
     * Definition: {@code 0}
     */
    ...
    /**
     * Platform Window: Disable platform decorations: title bar, borders, etc. (generally set all
     * windows, but if ImGuiConfigFlags_ViewportsDecoration is set we only set this on
     * popups/tooltips)
     *
    ...
    /**
     * Platform Window: Disable platform task bar icon (generally set on popups/tooltips, or all
    ...
    /**
     * Platform Window: Renderer doesn't need to clear the framebuffer ahead (because we will fill
     * it entirely).
     *
    ...
    /**
     * Platform Window: Avoid merging this window into another host window. This can only be set via
    ...
    /**
     * Viewport can host multiple imgui windows (secondary viewports are associated to a single
    ...
    /**
     * Platform Window: Window is minimized, can skip render. When minimized we tend to avoid using
