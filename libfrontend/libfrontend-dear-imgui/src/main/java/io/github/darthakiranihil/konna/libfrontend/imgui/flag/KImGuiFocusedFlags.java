 ...
 * @since 0.3.0
 */
public final class KImGuiFocusedFlags {
    /**
     * Definition: {@code 0}
     */
    ...
    /**
     * Return true if any window is focused. Important: If you are trying to tell how to dispatch
     * your low-level inputs, do NOT use this. Use 'io.WantCaptureMouse' instead! Please read the
     * FAQ!
     *
    ...
    /**
     * Do not consider popup hierarchy (do not treat popup emitter as parent of popup) (when used
    ...
    /**
     * Consider docking hierarchy (treat dockspace host as parent of docked window) (when used with
