 ...
 * @since 0.1.0
 */
public final class KImGuiConfigFlags {
    /**
     * Definition: {@code 0}
     */
    public static final int None = 0;
    /**
     * Master keyboard navigation enable flag. Enable full Tabbing + directional arrows +
     ...
     * moving a virtual mouse is awkward. Will update io.MousePos and set io.WantSetMousePos=true.
     * If enabled you MUST honor io.WantSetMousePos requests in your backend, otherwise ImGui will
    ...
    /**
     * Instruct backend to not alter mouse cursor shape and visibility. Use if the backend cursor
     * changes are interfering with yours and you don't want to use SetMouseCursor() to change mouse
     * cursor. You may want to honor requests from imgui by reading GetMouseCursor() yourself
     * instead.
     *
    ...
    /**
     * Instruct dear imgui to disable keyboard inputs and interactions. This is done by ignoring
    ...
    /**
     * [BETA: Don't use] FIXME-DPI: Reposition and resize imgui windows when the DpiScale of a
     * viewport changed (mostly useful for the main viewport hosting other window). Note that
    ...
    /**
     * [BETA: Don't use] FIXME-DPI: Request bitmap-scaled fonts to match DpiScale. This is a very
     * low-quality workaround. The correct way to handle DPI is _currently_ to replace the atlas
     * and/or fonts in the Platform_OnChangedViewport callback, but this is all early work in
     * progress.
     *
