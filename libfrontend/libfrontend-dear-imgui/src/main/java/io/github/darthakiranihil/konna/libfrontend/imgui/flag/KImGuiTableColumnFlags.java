...
/**
 * Flags for
 * {@link io.github.darthakiranihil.konna.libfrontend.imgui.KImGui#tableSetupColumn(String, int)}.
 *
 * @author Darth Akira Nihil
 * @since 0.1.0
 */
public final class KImGuiTableColumnFlags {
    /**
    ...
    /**
     * Overriding/master disable flag: hide column, won't show in context menu (unlike calling
    ...
    /**
     * Column will stretch. Preferable with horizontal scrolling disabled (default if table sizing
    ...
    /**
     * Column will not stretch. Preferable with horizontal scrolling enabled (default if table
    ...
    /**
     * Disable manual reordering this column, this will also prevent other columns from crossing
     * over this column.
     *
    ...
    /**
     * Disable ability to sort on this field (even if ImGuiTableFlags_Sortable is set on the
     * table).
     *
    ...
    /**
     * TableHeadersRow() will not submit horizontal label for this column. Convenient for some small
    ...
    /**
     * Ignore current Indent value when entering cell (default for columns{@code >}0). Indentation
    ...
    /**
     * Status: is enabled == not hidden by user/api (referred to as "Hide" in _DefaultHide and
     * _NoHide) flags.
     *
     ...
     *
     * <p>Definition:
     * {@code ImGuiTableColumnFlags_IndentEnable | ImGuiTableColumnFlags_IndentDisable}
     */
     ...
     *
     * <p>Definition:
     * {@code ImGuiTableColumnFlags_IsEnabled | ImGuiTableColumnFlags_IsVisible |
     * ImGuiTableColumnFlags_IsSorted | ImGuiTableColumnFlags_IsHovered}
     */
    public static final int StatusMask_ = 251658240;
    /**
     * [Internal] Disable user resizing this column directly (it may however we resized indirectly
     * from its left edge)
     *
    ...
    private KImGuiTableColumnFlags() {
    }
}
